    ...
    <div class="col-lg">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('data-ortu.create') }}" class="btn btn-primary">
                    <i class="fa fa-plus"></i>
                    Tambahkan Data
                </a>
            </div>
            <div class="card-body table-responsive">
                <h4 class="card-title">List Data Orang Tua</h4>
                <table class="table table-bordered table-striped" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $data->alamat ?? '-' }}</td>
                            <td class="d-flex">
                                <form action="{{ route('data-ortu.destroy', $data->id) }}" method="POST" class="d-flex">
                                    @csrf
                                    <a href="{{ route('data-ortu.edit', $data->id) }}" class="btn btn-sm btn-info">
