    ...
    <div class="col-lg">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('data-absensi.create') }}" class="btn btn-primary">
                ...
                <table class="table table-bordered table-striped" id="myTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $data->status ?? '-' }}</td>
                            <td class="d-flex">
                                <form action="{{ route('data-absensi.destroy', $data->id) }}" method="POST" class="d-flex">
                                    @csrf
                                    <a href="{{ route('data-absensi.edit', $data->id) }}" class="btn btn-sm btn-info">
