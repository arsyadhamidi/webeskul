...
@section('content')
    <div class="row">
        <div class="col-lg">
            <form action="{{ route('data-absensi.update', $absensis->id) }}" method="POST">
                @csrf
                <div class="card">
                                    ...
                                    <div class="form-group" style="margin-left: 30px">
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="status"
                                                value="Hadir" {{ $absensis->status == 'Hadir' ? 'checked' : '' }}>
                                        ...
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="status"
                                                value="Sakit" {{ $absensis->status == 'Sakit' ? 'checked' : '' }}>
                                            <label class="form-check-label">
                                                Sakit
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="radio" name="status"
                                                value="Izin" {{ $absensis->status == 'Izin' ? 'checked' : '' }}>
                                            <label class="form-check-label">
                                                Izin
                                            </label>
                                        </div>
