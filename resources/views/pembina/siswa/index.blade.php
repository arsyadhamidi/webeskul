...
@section('content')
    <div class="row mb-4">
        <div class="col-lg">
            <form action="{{ route('pembina-siswa.index') }}" method="GET">
                @csrf
                <div class="card">
                    <div class="card-body">
        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('pembina-siswa.create') }}" class="btn btn-primary">
                        ...
                        <tbody>
                            @foreach ($siswas as $data)
                                <tr>
                                    ...
                                    <td>{{ $data->jk ?? '-' }}</td>
                                    <td class="d-flex">
                                        <form action="{{ route('pembina-siswa.destroy', $data->id) }}" method="POST"
                                            class="d-flex">
                                            @csrf
                                            <a href="{{ route('pembina-siswa.edit', $data->id) }}"
