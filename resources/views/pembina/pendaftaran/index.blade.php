...
@section('content')
    <div class="row mb-4">
        <div class="col-lg">
            <form action="{{ route('pembina-pendaftaran.index') }}" method="GET">
                @csrf
                <div class="card">
                    <div class="card-body">
        ...
        <div class="col-lg">
            <div class="card">
                <div class="card-header">
                    <a href="{{ route('pembina-pendaftaran.create') }}" class="btn btn-primary">
                        <i class="fa fa-plus"></i>
                        Tambahkan Data
                    </a>
                    <a href="{{ route('pembina-pendaftaran.generatepdf') }}" class="btn btn-danger" target="_blank">
                        ...
                        <tbody>
                            @foreach ($daftars as $data)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('pembina-pendaftaran.destroy', $data->id) }}" method="POST"
                                            class="d-flex">
                                            @csrf
                                            <a href="{{ route('pembina-pendaftaran.edit', $data->id) }}"
                                                class="btn btn-sm btn-info">
                                                <i class="fa fa-edit"></i>
                                            </a>
                                            <a href="{{ route('pembina-pendaftaran.show', $data->id) }}"
